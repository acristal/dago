...
func processFile(file string) {
	...
	if err := g.generate(); err != nil {
		glog.Fatalf("Failed to generate go code: %v", err)
	}
	src := g.format()
...
func (g *Generator) printHeader() {
	g.Printf("// generated by dago %s; DO NOT EDIT\n", strings.Join(os.Args[1:], " "))
	g.Printf("// Dago is Relational Persistence for Golang, released under LGPL 2.1\n")
	g.Printf("\n")
